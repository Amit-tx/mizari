...
export function DashboardClient({ 
  ...
  const [visibleThemesCount, setVisibleThemesCount] = useState(24);

  // Reset pagination when tab or search changes
  useEffect(() => {
    setVisibleThemesCount(24);
  ...
  // Waits for DOM to update before measuring (requestAnimationFrame × 2).
  const scrollToSection = (sectionId: string) => {
    // Use setTimeout instead of just rAF for more reliable timing
    setTimeout(() => {
            ...
            <div 
              ...
              onScroll={(e) => {
                ...
                if (target.scrollHeight - target.scrollTop <= target.clientHeight + 20) {
                  setVisibleThemesCount((prev) => prev + 12);
                }
              }}
            >
