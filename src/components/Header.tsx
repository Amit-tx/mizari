      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          {session ? (
            <Link
              href="/dashboard"
              className="ml-2 rounded-lg bg-gradient-to-r from-[#111827] to-[#111827] px-4 py-2 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:shadow-md hover:brightness-110"
            >
              Dashboard
            </Link>
          ) : (
        ...
        <nav className="flex flex-col gap-1 px-4 py-3">
          ...
          {session ? (
            <Link
              href="/dashboard"
              onClick={() => setMobileOpen(false)}
              className="rounded-lg bg-gradient-to-r from-[#111827] to-[#111827] px-4 py-2.5 text-center text-sm font-semibold text-white"
            >
              Dashboard
            </Link>
          ) : (
